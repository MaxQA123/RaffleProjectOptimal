...
namespace RaffleProjectOptimal.PageObjects.CheckoutPage
{
    public partial class Checkout
    {
        ...
        public IWebElement CheckBoxIAmCheckout => Browser._Driver.FindElement(_CheckBoxIAmCheckout);
        public readonly static By _CheckBoxIAmCheckout = By.XPath("//span[@class = 'MuiIconButton-label']/input");
        ...
        public readonly static By _buttonCompleteOrderChcktPg = By.XPath("//div[@class = 'payConfirmBtn']/button");
    }
}
