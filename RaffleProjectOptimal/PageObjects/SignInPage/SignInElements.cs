...
namespace RaffleProjectOptimal.PageObjects.SignInPage
{
    ...
    {
        public IWebElement HomePageSignInButton => Browser._webDriver.FindElement(_homePageSignInButton);
        ...
        public IWebElement PasswordInputField => Browser._webDriver.FindElement(_passwordInputField);
        public readonly static By _passwordInputField = By.XPath("//input[@name = 'password']");

        public IWebElement SignInButton => Browser._webDriver.FindElement(_signInButton);
