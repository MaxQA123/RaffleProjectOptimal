...
namespace RaffleProjectOptimal.PageObjects.SignUpPage
{
    public partial class SignUp
    {
        ...
        public readonly static By _optInCheckBox = By.XPath("//p[@class = 'checkboxDesc'//p[@text() ='Opt in to receive email and text communication from us / Unsubscribe at any time']");
        public IWebElement RememberMeCheckBox => Browser._Driver.FindElement(_rememberMeCheckBox);
        public readonly static By _rememberMeCheckBox = By.XPath("//span[@class = 'MuiTypography-root MuiFormControlLabel-label MuiTypography-body1']");
